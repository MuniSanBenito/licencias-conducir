...
export type CiudadanoFormData = Pick<
  Ciudadano,
...
interface CiudadanoFormProps {
  title: string
  defaultValues?: Partial<CiudadanoFormData>
  onSubmit: (data: CiudadanoFormData) => Promise<void>
}

export function CiudadanoForm({ title, defaultValues, onSubmit }: CiudadanoFormProps) {
  const {
    register,
    handleSubmit,
    formState: { errors, isSubmitting },
  } = useForm<CiudadanoFormData>({ defaultValues })
