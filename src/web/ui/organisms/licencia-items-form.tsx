'use client'
import { CLASE_LICENCIA_DEFAULT, CLASES_LICENCIA, type ClaseLicencia } from '@/constants/clases'
...
export function LicenciaItemsForm({ items, onItemsChange }: LicenciaItemsFormProps) {
  const agregarItem = () => {
    onItemsChange([...items, { clase: CLASE_LICENCIA_DEFAULT, tipo: TIPO_TRAMITE.NUEVA }])
  }
